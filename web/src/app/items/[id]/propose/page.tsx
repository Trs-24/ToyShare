                ...
                myItems.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative cursor-pointer flex items-center gap-6 p-4 rounded-[28px] border-2 transition-all ${
                        isSelected
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="px-2 py-0.5 rounded-lg bg-orange-100 text-orange-700 text-[10px] font-black uppercase tracking-tighter">
                            ✨ Рекомендовано
                          </span>
                        </div>
                        <p className="text-sm text-gray-500 font-medium">
                          {item.condition === 'NEW' ? 'Новое' : 'Как новое'}
                        </p>
                      </div>
                      ...
                      {disabled && (
                        <div className="absolute inset-x-0 -bottom-2 flex justify-center">
                          <span className="bg-gray-800 text-white text-[10px] px-3 py-1 rounded-full shadow-sm font-bold">
